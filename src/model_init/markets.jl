function setup_markets!(world::Ark.World, properties::Properties)
    ...
    ) do entities, sector, final_demand_book, final_demand_clearing, intermediate_demand_book, intermediate_demand_clearing, first_pass_intermediate, first_pass_final, supply_pool, capacity_pool, price_pool, weights
